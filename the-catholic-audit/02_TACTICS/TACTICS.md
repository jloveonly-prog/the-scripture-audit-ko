...
*   **⚔️ 성경 법정 (별도 엔진 — BVCAP)**: KJV 원문과 가톨릭 교리의 충돌은 `../the-scripture-audit/`가 담당 (가톨릭 특화 성경 무기: `../the-scripture-audit/04_QUIVER(무기고)/CATHOLIC_TARGETED_WEAPONS.md`). 최종 콘텐츠 단계에서 두 보고서를 병합한다.
