...
OUTPUT_PATH = r"D:\01.TheScriptureAudit_ko\the-catholic-audit\08_REPORT\llm_verified_conflicts.csv"
TOP_N = 100 # 상위 100개만 우선 검사
...
"""
    ...
    print(f"\n심사 완료! {TOP_N}건 중 진짜 모순으로 판정된 사례는 총 {len(verified_conflicts)}건입니다.")
    
    if verified_conflicts:
        fieldnames = list(candidates[0].keys()) + ['LLM_Decision', 'LLM_Reason']
