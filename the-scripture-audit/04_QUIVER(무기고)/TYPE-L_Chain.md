...
【1단계】 창 1:26 "우리(us)" — 왕적 복수인지 복수 표현이 가리키는 대상이 무엇인지는 해석이 갈리는 지점이다(`LEXICON_Bible.md` 섹션 6 참조, 신학체계 라벨을 결론으로 쓰지 않는다)
         bara×3 = 창 1:1~3에 등장하는 "하나님/영/말씀" 표현 수와의 대응 여부를 다음 단계에서 검증
   ↓ TYPE-F (본문 내 반복·병행 구조)
   ↓ "창 1:1-3에 이 표현들이 몇 차례·어떤 순서로 등장하는가?"

【2단계】 창 1:1 하나님 / 창 1:2 "하나님의 영(Spirit of God)" / 창 1:3 "말씀하시되(said)"(요 1:1-3과 교차 확인)
         → 세 표현이 창조 장면에 함께 등장한다는 본문 사실 확인 — 이 병행이 지지하는 신학적 결론은 이 단계에서 확정하지 않고 GATE 5(최종 판정)로 이월한다
   ↓ TYPE-I + TYPE-G
...
【3단계】 called = 정확히 5회 (낮·밤·하늘·땅·바다)
   ...
   ↓ TYPE-I (대칭 설계)
   ↓ "창 1:27이 22단어라면, 하늘의 세 증인을 언급하는 다른 구절도 22단어인가?"
