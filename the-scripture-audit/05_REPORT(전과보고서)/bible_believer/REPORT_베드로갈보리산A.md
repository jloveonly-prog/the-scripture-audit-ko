...
```
서로 다른 독립 책(저자) 수: 요한복음 1개 (베드로전서는 사건 당사자의 자기 서술이므로
제3자 독립 증인으로 카운트하지 않음 — TYPE-I 빈도 집중 근거일 뿐)
→ ⚠️ [교차증인 미확인]
```

### [STEP 4] 신학적 결정

| 내부 등급 | 교차증인 태그 | 목회 적용 등급 |
|:---:|:---:|:---:|
| 🟢 IRONCLAD (8콤보 무모순) | ⚠️ 교차증인 미확인 | 🟡 **개연성(Probability)** |

> **결론:** "베드로가 로마에서 죽지 않았다"(반증 논증)는 강하게 유지된다 — 로마설은 성경 침묵(행 전체 무언급, 벧전 5:13 바빌론 명시) 및 1클레멘스 침묵으로 이중 약화된다.
