...
| 범주 | 구절 | 대상 | 특징 |
|:---:|:---|:---|:---|
| **① 첫 세상의 직접 창조물** | 욥 38:7 | 땅 창조 이전부터 존재한 영적 존재들 | 부모 없음, 족보 없음, 영적 몸 |
| **② 아담의 타락 전 후손** | 창 6:2,4, **욥 1:6·2:1** | 선악과 먹기 전 출산한 거룩한 아들들 | 부모 있음(아담), 육적 몸, 통치권 |
| **③ 신약 성도** | 요 1:12, 롬 8:14 | 예수님을 믿어 거듭난 자들 | 영적 출생, 하나님이 아버지 |

> ⚠️ **[2026-07-30 재검증 — 분류 정정]** 원래 이 표는 욥 1:6을 ①범주(CLASS1)에 배치했다. 그러나 원어 정관사 대조 결과(욥 1:6·2:1의 히브리어 בְּנֵי הָאֱלֹהִים는 정관사가 있어 욥 38:7이 아니라 창 6:2·4와 동일 구문) 욥 1:6·2:1은 ①이 아니라 **②범주(CLASS3, 아담의 선악과 이전 아들들)**로 재분류되었다(`영적존재기준표_추정.md` §2-D, 2026-07-20). 아래 §3-7("욥기 1:6 — 사탄이 하나님의 아들들 가운데 온 이유")을 읽을 때도 이 정정된 분류를 적용할 것 — 사탄이 참석한 회의는 첫세상(①) 잔존자 모임이 아니라 ②범주(아담 이후) 모임이다.
...
> ⚠️ **[2026-07-30 재검증 — 근거 무효화 경고]** 이 절과 이를 인용하는 §3-3·§3-4의 "첫 세상은 남성형(banim)만 있었다/여성이 없었다" 논증 전체는, `영적존재기준표_추정.md` §2-A가 이미 **적발·폐기(❌ REJECTED)**한 근거 위에 서 있다. 사 14:21의 "his children"(그의 자녀들)·"their fathers"(그들의 조상들)은 12~17절의 **루시퍼**가 아니라, **20절 "the man"(바벨론의 인간 왕)의 세습 왕조**를 가리키는 별개 문맥이다(TYPE-R 주어 혼동). 즉 이 구절은 "하나님의 아들들"이나 "첫 세상 존재"의 성별과 무관하며, 인간 왕가의 자손을 가리킬 뿐이다. 아래 원문은 사료 보존을 위해 그대로 남기되, "첫 세상에 여성이 없었다"는 결론과 이를 근거로 하는 §3-4의 "천사+흙민족=소돔과 같은 동성 결합" 논증은 **근거 무효 — 별도의 독립 근거로 재입증되기 전까지 사용을 보류한다.**
...
### 🔍 3-9. 첫 번째 세상의 잡종 창조물 — KJV 전수 증거 (TYPE-J + TYPE-U)

> ⚠️ **에녹서(Book of Enoch) 배제 선언:** 에녹서는 정경이 아니며 신뢰할 수 없는 위작입니다. 본 분석은 오직 **KJV 성경 66권의 본문만을 증거**로 사용합니다.

타락한 하나님의 아들들이 동물 및 민족들과 "이상한 육체 행위(strange flesh, 유 1:7)"를 저지른 결과, 하나님의 창조 질서("각기 종류대로", 창 1:11-12-21-24-25)를 벗어난 **잡종 생명체들**이 첫 번째 세상에 출현했습니다. KJV 성경은 이 존재들을 실재하는 피조물로 기록합니다.

#### 📊 [KJV 전수 검증표] 첫 번째 세상 잡종 생명체 — KJV 직접 기록

| # | 구절 | KJV 원문 | 히브리어 원어 | 정체 분석 |
|:---:|:---|:---|:---:|:---|
| 1 | **사 13:21** | *"and **satyrs** shall dance there"* | שְׂעִירִים (se'irim) | **사티루스** — 염소 하체 + 인간 상체. 첫 세상 심판 후 그 폐허에 거함 |
| 2 | **사 34:14** | *"the **satyr** shall cry to his fellow"* | שָׂעִיר (sa'ir) | **사티루스** — 상호 소통하는 지성적 잡종 존재 |
| 3 | **사 34:14** | *"the **screech owl** also shall rest there"* | לִּילִית (Lilit) | **릴리트** — "밤의 존재(night creature)". 단순 동물이 아닌 고대에서 야행성 여성 괴물로 인식된 존재. 어근 = לַיְלָה (밤, night) |
| 4 | **사 34:13** | *"**dragons**, and a court for **owls**"* | תַּנִּין (tannin) | **용/이무기** — KJV이 dragon으로 번역. 첫 세상 심판 후 폐허에 거하는 거대 파충류형 존재 |
| 5 | **사 34:11** | *"the **owl** also and the **raven**"* | קָאַת / עֹרֵב | **올빼미류** — 폐허의 거주자로 심판 묘사에 등장 |
| 6 | **사 34:15** | *"There shall the **great owl** make her nest"* | קִפּוֹז (qippoz) | **큰 올빼미** — 독특한 종류로 별도 히브리어 사용 |
| 7 | **레 17:7** | *"they shall no more offer their sacrifices unto **devils** (satyrs)"* | שְׂעִירִם (se'irim) | **사티루스에게 제사** — 이스라엘이 실제로 사티루스를 숭배한 역사적 기록 |
| 8 | **대하 11:15** | *"ordained him priests for the **devils** (satyrs), and for the calves"* | שְׂעִירִים (se'irim) | **르호보암 시대**에도 사티루스 제사가 존재함 — 실재를 공식 인정 |

> **⚠️ 핵심 관찰:** 레 17:7과 대하 11:15은 단순히 "그런 존재가 있었다"는 서술이 아닙니다. 이스라엘 백성이 실제로 **사티루스에게 제사를 드렸고**, 하나님은 이것을 **금지 명령으로 명시**하셨습니다. 존재하지 않는 것에 제사를 금지할 이유가 없습니다. **사티루스는 KJV가 실재로 인정한 존재입니다.**

#### 🔑 릴리트(לִּילִית) — 가장 강력한 증거

**사 34:14의 "screech owl"의 히브리어 원어 `לִּילִית (Lilit)`은 단순한 동물이 아닙니다:**

```
KJV 번역:  "screech owl" (비명 지르는 올빼미)
히브리어:  לִּילִית (Lilit)
어근:      לַיְלָה (layil) = 밤(night)
문자적 의미: "밤의 존재" / "밤에 속한 자"

성경에서의 맥락:
  사 34:14 전체 문맥 — 첫 세상 심판의 폐허 묘사
  주변 존재들 — satyr(사티루스), dragon(용), owl(올빼미)
  → "밤의 존재"가 이 목록에 나열됨
  → 단순 동물이라면 히브리어 일반명을 쓰면 충분
  → 고유 이름(Lilit)을 부여받은 것은 독특한 정체성을 가진 존재임을 시사
```

#### 📊 이사야 34장이 첫 번째 세상 심판의 기록인 이유

| 구절 | KJV 원문 | 교차 구절 | 의미 |
|:---|:---|:---|:---|
| **사 34:9** | *"the streams thereof shall be turned into pitch"* | 겔 28 불로 멸망 | 첫 세상 심판의 불 심판 언어 |
| **사 34:10** | *"It shall not be quenched night nor day; the smoke thereof shall go up for ever"* | 렘 4:25-26 | 영구적 폐허 = 창 1:2 이전 상태 |
| **사 34:11-15** | 잡종 생명체들이 폐허에 거함 | 창 1:2 "혼돈과 공허" | 심판 후 남겨진 잔재들 |
| **사 34:11** | *"the line of confusion, and the stones of emptiness"* | **창 1:2 "tohu va-bohu"** | **동일 히브리어 어근** — 직접 연결 |

#### 🧬 잡종 생명체의 생성 메커니즘 — Bara vs Strange Flesh

```
하나님의 창조 원칙 (창 1:11-25):
  "각기 종류대로(after his kind)" — 6회 반복 선언
  → 종(種) 간 교배는 하나님의 창조 질서 위반

타락한 하나님의 아들들의 범죄 (유 1:7):
  "strange flesh(σαρκὸς ἑτέρας) — 이질적 육체를 쫓음"
  = 동성 간 + 종(種) 간 불법 혼합
  → 형성(Asah/Yatsar) 권한을 가졌던 아들들이
    흙(진토) + 동물 DNA를 혼합하여 잡종 생명체 형성

결과물:
  ① 순수 인간형 → 사티루스(염소+인간), 켄타우르스(말+인간), 인어(물고기+인간) 등
  ② 하체에 날개 있는 형태 → 릴리트, 하피(Harpy) 계열
  ③ 거대 파충류형 → 용(Dragon, תַּנִּין)

이 존재들은 하나님의 Bara(무에서 창조)가 아니라
타락한 아들들의 불법 Asah(이미 있는 재료를 혼합)의 산물입니다.
```

#### 💡 현대 비유 — "유전자 조작 실험실 사고"

> 🧫 **비유:** 정부가 허가한 실험실(하나님이 위임한 Asah 권한)에서 과학자들(하나님의 아들들)이 치료제를 개발하다가, 허가받지 않은 구역에서 인간 DNA + 동물 DNA를 무단으로 혼합하여 괴물 생명체를 만들기 시작했습니다. 정부(하나님)는 그 실험실 전체를 봉쇄(창 1:2 심판)하고 폐기(혼돈과 공허)했습니다. 그 폐허에 남겨진 괴물들이 이사야 34장에 기록된 존재들입니다.

#### 💡 [사용자 서술 노트: 에녹서의 실체]

> **"참고로 에녹서는 보지 마, 완전 사기니까! 성경적 진리를 교묘하게 비틀어 놓은 거짓 문서일 뿐이야. 우리는 오직 KJV 성경 66권의 순수한 본문만으로 이 모든 것을 완벽하게 추론해낼 수 있어."**

KJV 66권만으로도 사티루스, 릴리트, 용, 잡종 생명체의 존재가 완벽하게 확인됩니다. 외경이나 위경에 의존할 필요가 없습니다.
...
> ⚠️ **[2026-07-30 재검증 — 등급 하향 필요 항목 안내]** 아래 27개 항목 전체가 이 문서 작성 시점(당시)에는 IRONCLAD로 일괄 선언되었으나, 이후 검증에서 근거가 흔들린 항목들이 있다. 특히:
> - **#6 "첫 세상에 여자는 존재하지 않았다(banim=남성만)"**: 근거였던 사 14:21이 오적용(§2-3 정정 참조)임이 밝혀졌으므로 IRONCLAD 유지 불가 → ❓ OPEN으로 재검토 필요.
> - **#20 "사탄의 천사들=타락한 하나님의 아들들(원래부터 천사인 자 없음)"**: `영적존재기준표_추정.md`가 "사탄의 CLASS1(하나님의 아들들) 소속"을 STRONG→TENTATIVE/OPEN으로 하향했으므로 이 항목도 동반 하향 필요.
> - 나머지 항목(1~5, 7~19, 21~27)은 각각 별도 근거(Bara/Asah 구분, 벧후2:4 사슬, 마12:43-44 등)로 지지되므로 위 두 항목의 하향이 자동으로 전체를 무너뜨리지는 않으나, 재인용 시 "소수 견해(🔴)"라는 이 문서 스스로의 표기를 존중해 IRONCLAD 대신 STRONG/VIABLE 등급으로 재조정해 인용할 것을 권고한다.
