...
## 📚 관련 문서 — KJV 바이블 빌리버를 위한 추천 읽기 순서

> **이 논증 체계는 KJV 66권 텍스트만을 증거로 사용합니다. 에녹서·외경은 단 한 구절도 사용하지 않습니다.**

> **간극 이론(Gap Theory)을 믿으신다면 이 순서대로 읽으십시오. 1번에서 시작하십시오.**

---

#### 📌 1번 — 먼저 이것부터: IFB와 TSM의 순서 차이 한눈에 보기

> **[순서도비교_IFB_vs_TheScriptureMaster](./REPORT_순서도비교_IFB_vs_TheScriptureMaster.md)**

**왜 1번인가:** 간극 이론(Gap Theory)을 믿는 분이라면 창 1:2 이전에 첫 세상이 있었다는 것에 이미 동의하신 겁니다. 그런데 그 첫 세상의 천사 심판을 증언하는 벧후 2:4를 창 6장으로 배치하면, 베드로 자신이 자기 모순을 범하게 됩니다 — *"spared not"(벧후 2:4) vs "longsuffering"(벧전 3:20)*. 이 한 쌍의 언어가 모든 논증의 출발점입니다.

---

#### 📌 2번 — KJV 텍스트 직접 확인: 새벽별 ≠ 천사, 용례 0건

> **[첫번째_세상민족](./REPORT_첫번째_세상민족.md)**

**왜 2번인가:** "KJV에서 새벽별(morning star)이 천사를 가리키는 용례가 몇 건인가?" 답은 **0건**입니다. "천사가 노래한(sang)" 용례도 **0건**입니다 — KJV는 항상 "saying"을 씁니다. 텍스트가 직접 말합니다.

---

#### 📌 3번 — 핵심 논증: 베드로가 정반대 언어를 쓴 이유

> **[창세기6장_하나님의아들들_주장교차검증](./REPORT_창세기6장_하나님의아들들_주장검증_Masterpiece.md)**

**왜 3번인가:** 이 문서 하나가 천사설 전체를 분쇄합니다. *벧전 3:20 "longsuffering of God waited"(오래 참으셨다) vs 벧후 2:4 "spared not"(아끼지 않으셨다)* — 같은 저자 베드로가 같은 대상에 정반대 언어를 쓸 이유가 없습니다. 두 사건이 완전히 다른 시대임을 저자 자신이 언어로 증언합니다.

---

#### 📌 4번 — 법정 검증: 선악과 이전 아담의 자녀 존재 여부 9건

> **[창세기3장6장_하나님의아들들](./REPORT_창세기3장6장_하나님의아들들.md)**

**왜 4번인가:** 창 6장 하나님의 아들들이 아담의 선악과 이전 자녀들이라는 주장을 검사 측(천사설) vs 변호인 측(인간설) 법정 형식으로 9건 전부 검증합니다. 겔 18:20 사법 원칙과 고라의 자녀 평행 구조 포함.

---

#### 📌 5번 — 살아있는 증거: 멜키세덱은 누구인가?

> **[멜키세덱_정체성검증](./REPORT_멜키세덱_정체성검증_Masterpiece.md)**

**왜 5번인가:** 히 7:3 "without father, without mother, without descent, having neither beginning of days, nor end of life" — 이 구절이 히브리서에 이미 살아있는 첫 세상 하나님의 아들을 묘사합니다. 그리스도 현현설은 17개 텍스트 충돌로 기각됩니다.
...
**왜 6번인가:** 재창조(Gap Theory), 창조(Bara) vs 만듦(Asah/Yatsar), 첫 세상의 민족·도시·왕국 전체 구조를 렘 4:23-26·사 14·겔 28 텍스트로 확인합니다. 이 문서를 읽으시면 전체 그림이 완성됩니다.

---

#### 📌 7번 — 완전 분류표: 하나님의 아들들·천사·마귀를 OOP로 구분

> **[영적존재분류표](./REPORT_영적존재분류표.md)** ← 현재 문서

**왜 7번인가:** 비슷해 보이는 것들(그룹 ≠ 천사, 첫세상 아들 ≠ 천사, 마귀 ≠ 타락 천사)을 KJV 텍스트로 정밀하게 구분합니다. "비슷한 것을 같은 것으로 묶는 해석"이 어떻게 교리 오류를 만드는지 확인하십시오.

---

### 📎 보조 자료 — 실전 논쟁 기록 (AI와의 실제 공방)
