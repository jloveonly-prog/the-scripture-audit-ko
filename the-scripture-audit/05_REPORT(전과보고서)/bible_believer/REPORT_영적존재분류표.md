...
## 👑 6-A. CLASS 4-B — 신약 성도: 자녀들(Children)과 아들들(Sons)의 차원적 차이

> **KJV 핵심 근거:** 요 1:12 / 롬 8:17 / 눅 20:36
> **TYPE-AL (유사성 오류 방지):** 구원받은 거대한 무리인 '자녀들(Children)'과, 우주 통치권을 상속받는 '아들들(Sons)'은 완전히 다른 지위입니다.

```javascript
// 1. 일반 구원받은 성도 (자녀들)
class ChildrenOfGod extends Spirit {
  status:      "구원받은 자 (Saved)"
  grace:       "예수의 피로 씻음 받음"
  inheritance: Heirs (상속자들, 롬 8:17)
  // 천사들과 동등한 지위 (눅 20:36 "equal unto the angels... children of God")
}

// 2. 이기는 자들 (아들들 - 통치 권세 상속)
class SonsOfGod_NewCreation extends ChildrenOfGod {
  power:       "Sons of God이 되는 권능(Power, 요 1:12)"
  royalty:     true (왕권 상속, 계 3:21)
  role:        "첫 세상 타락한 아들들의 빈 왕좌 대체"
  // 단순한 상속(Heirs)을 넘어 우주적 통치권(archē)을 획득함
}
```

| 구분 | 하나님의 자녀들 (Children of God) | 하나님의 아들들 (Sons of God) |
|:---|:---|:---|
| **KJV 명칭** | Children | Sons |
| **영적 신분** | 예수 피로 구원받은 상속자 | 첫 세상 타락한 아들들의 왕좌를 대체할 통치자 |
| **핵심 구절** | 롬 8:17 "자녀(children)이면 상속자(heirs)" | 요 1:12 "아들들(Sons)이 되는 **권능(power)**을 주셨으니" |
| **권세 수준** | 천사들과 동등한 신분 (눅 20:36) | 우주 열국을 통치하는 왕적 권능 (계 3:21) |
| **번역의 기적** | 헬라어 *tekna*를 일반적 문맥에서 'children'으로 번역 | 요 1:12에서 동일한 *tekna*를 통치권을 의미하는 **'Sons'**로 승격 번역 (KJV의 영감적 통찰) |

> [!IMPORTANT]
> **요한복음 1:12의 'Sons' 번역은 오역이 아닙니다.**
> 헬라어 원어주의자들은 *tekna*(자녀들)를 KJV가 'Sons'로 번역한 것을 오역이라고 비판합니다. 그러나 KJV는 로마서 8:17의 기본적 상속(Heirs)과 요한복음 1:12의 우주적 통치권(Power)을 완벽하게 구분했습니다. 
> 십자가의 피로 구원받은 모든 자는 천사들과 동등한 '자녀(Children)'의 신분을 얻지만, 요한복음 1:12는 이를 뛰어넘어 타락한 첫 세상 통치자들의 빈자리를 차지할 **'아들들(Sons)이 되는 권능(Power)'**을 약속하는 초월적 구절입니다. 즉, 성도가 궁극적으로 도달할 통치자(Sons)의 지위를 성령의 영감으로 철저히 보호한 KJV만의 위대한 기적입니다!
...
마귀들(첫 세상에서 이종 교배로 태어났다가 몸이 파괴된 하이브리드 영들)과 타락한 천사들은 다음과 같은 특화된 권능을 발휘합니다.
