...
rename_map = {
    "REPORT_TheScriptureMasterVS연구원.md": "REPORT_TheScripture.org_VS_연구원.md",
    "REPORT_TheScriptureMasterVS연구원v2.md": "REPORT_TheScripture.org_VS_연구원v2.md",
    "REPORT_TheScriptureMasterVS연구원v3.md": "REPORT_TheScripture.org_VS_연구원v3.md",
    "REPORT_순서도비교_IFB_vs_TheScriptureMaster.md": "REPORT_순서도비교_IFB_vs_TheScripture.org.md"
}
