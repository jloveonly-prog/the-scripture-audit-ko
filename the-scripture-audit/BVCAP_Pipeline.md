...
# 🧠 BVCAP Skill Pipeline v2.9 (the-scripture-audit의 내부 엔진)
...
## 🗺️ [TYPE 전체 맵 — v3.0 (TYPE 30종 실전 무기)]

> **이 30종이 실제 04_QUIVER(무기고) 파일로 존재하는 포렌식 무기입니다.**
> FULL SCAN 실행 시 TYPE-M부터 TYPE-AC까지, 그리고 TYPE-B-π를 순서대로 점검합니다.
> v3.0 업데이트: TYPE-AC(역가설 대입 검증) 추가 — 베드로 갈보리 순교설 전례에서 도출.
