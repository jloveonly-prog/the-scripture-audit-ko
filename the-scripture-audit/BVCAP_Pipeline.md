...
[GATE 3] 해당 TYPE의 SKILL (FULL SCAN) 실행
  → 하단의 **FULL SCAN 실행 프로토콜**을 따라 QUIVER 전종 무기를 순차 발동한다.
...
| **B-π** ⭐ v3.0 | 지각 필터 (Perception Filter) | 증인이 "봤으나 처리 불가" 상태 탐지 — SHOCK/GRIEF/CULTURAL/DIVINE 분류 |
