...
*Generated by BVCAP Skill Pipeline v2.7*
*구 v2.0 AIDD 파이프라인과 완전 통합 — ANCHOR-1·DE-OVERLAP·MATRIX-3·ANALOGY-5 추가*
*TYPE 확장: v2.6(A-Z) → v2.7(A-AB 28종 완비, 고대법/영적매트릭스 편입)*
...
| [F+E+G+N+P+I+T+S]_베드로_갈보리순교설.md | F+E+G+N+P+I+T+S | 7중 예표 + ὅπου 원어 + θέλω 어휘 연결 + 배타성 + 역논법 → CONFIRMED | ✅ |
