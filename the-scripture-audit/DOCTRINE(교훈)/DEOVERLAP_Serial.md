...
### 원칙 5. 단일 복음서 내부 순서 불가침 (Internal Narrative Sequence Lock)
...
### 원칙 6. 대명사 일관성 잠금 (Pronoun Coherence Lock)
...
**📌 전례**: `VERDICT(판결록)/VERDICT_부활아침_무덤사건_순차통합.md` 요 20:2 교훈 사례
...
| "이 복음서는 저 복음서와 순서가 다르다" | 단일 복음서 내부 순서부터 확인 — 원칙 5 적용 |
| "단수 주어라고 동행자 없다" | 인접 구절 WE/they 확인 — 원칙 6 적용 |

---

*DE-OVERLAP v4.0 — 원칙 6 (대명사 일관성 잠금) 추가*
