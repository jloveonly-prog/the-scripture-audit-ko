...
## 3. 프로그램 기본 사용법 (How to Run QVCAP)
...
## 5. [심화] AI를 통한 결과물 교차 검증 및 학습법 (For Scholars)
...
## 6. [부록] QVCAP 7.0 핵심 기준표 및 매트릭스 (Reference Guide)
...
## 7. 라이선스 및 저작권 (License & Copyright)
...
*   **GitHub**: [공식 저장소](https://github.com/jloveonly/the-scripture-audit)
*   **GitHub**: [QVCAP sub 저장소](https://github.com/jloveonly/qvcap)
*   **Website**: [TheScripture.org](https://TheScripture.org)
